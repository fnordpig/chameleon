...
#   timestamp: 2026-05-06T06:21:26+00:00
...
class AppToolConfig(BaseModel):
    ...
    approval_mode: AppToolApproval | None = Field(
        None, description='Approval mode for this tool.'
    )
    enabled: bool | None = Field(
        None,
...
class FeatureTomlForAppsMcpPathOverrideConfigToml(
    RootModel[bool | AppsMcpPathOverrideConfigToml]
):
...
class FilesystemPermissionToml(
    RootModel[FileSystemAccessMode | dict[str, FileSystemAccessMode]]
):
...
class HookHandlerConfig(
    RootModel[HookHandlerConfig1 | HookHandlerConfig2 | HookHandlerConfig3]
):
...
class MemoriesToml(BaseModel):
    ...
    extract_model: str | None = Field(
        None, description='Model used for thread summarisation.'
    )
...
class OAuthCredentialsStoreMode(
    RootModel[
        OAuthCredentialsStoreMode1
        | OAuthCredentialsStoreMode2
        | OAuthCredentialsStoreMode3
    ]
):
    root: (
        OAuthCredentialsStoreMode1
...
class ShellEnvironmentPolicyToml(BaseModel):
    ...
    include_only: list[str] | None = Field(
        None, description='List of regular expressions.'
    )
...
class ThreadStoreToml2(BaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    endpoint: str
...
class ThreadStoreToml(RootModel[ThreadStoreToml1 | ThreadStoreToml2]):
    root: ThreadStoreToml1 | ThreadStoreToml2
...
class TuiApprovalKeymap(BaseModel):
    ...
    approve: KeybindingsSpec | None = Field(
        None, description='Approve the primary option.'
    )
    ...
    cancel: KeybindingsSpec | None = Field(
        None, description='Cancel an elicitation request.'
    )
...
class TuiComposerKeymap(BaseModel):
    ...
    submit: KeybindingsSpec | None = Field(
        None, description='Submit the current composer draft.'
    )
...
class TuiEditorKeymap(BaseModel):
    ...
    delete_forward_word: KeybindingsSpec | None = Field(
        None, description='Delete the next word.'
    )
    ...
    move_down: KeybindingsSpec | None = Field(
        None, description='Move cursor down one visual line.'
    )
    move_left: KeybindingsSpec | None = Field(
        None, description='Move cursor left by one grapheme.'
    )
    ...
    move_up: KeybindingsSpec | None = Field(
        None, description='Move cursor up one visual line.'
    )
...
class TuiGlobalKeymap(BaseModel):
    ...
    clear_terminal: KeybindingsSpec | None = Field(
        None, description='Clear the terminal UI.'
    )
...
class TuiListKeymap(BaseModel):
    ...
    accept: KeybindingsSpec | None = Field(
        None, description='Accept current selection.'
    )
    cancel: KeybindingsSpec | None = Field(
        None, description='Cancel and close selection view.'
    )
    move_down: KeybindingsSpec | None = Field(
        None, description='Move list selection down.'
    )
...
class TuiPagerKeymap(BaseModel):
    ...
    half_page_down: KeybindingsSpec | None = Field(
        None, description='Scroll down by half a page.'
    )
    half_page_up: KeybindingsSpec | None = Field(
        None, description='Scroll up by half a page.'
    )
    ...
    page_down: KeybindingsSpec | None = Field(
        None, description='Scroll down by one page.'
    )
    page_up: KeybindingsSpec | None = Field(None, description='Scroll up by one page.')
    scroll_down: KeybindingsSpec | None = Field(
        None, description='Scroll down by one row.'
    )
...
class TuiVimNormalKeymap(BaseModel):
    ...
    move_left: KeybindingsSpec | None = Field(
        None, description='Move cursor left (`h`).'
    )
    move_line_end: KeybindingsSpec | None = Field(
        None, description='Move cursor to end of line (`$`).'
    )
    ...
    move_right: KeybindingsSpec | None = Field(
        None, description='Move cursor right (`l`).'
    )
    move_up: KeybindingsSpec | None = Field(
        None,
    ...
    paste_after: KeybindingsSpec | None = Field(
        None, description='Paste after cursor (`p`).'
    )
    ...
    yank_line: KeybindingsSpec | None = Field(
        None, description='Yank the entire line (`Y`).'
    )
...
class TuiVimOperatorKeymap(BaseModel):
    ...
    motion_down: KeybindingsSpec | None = Field(
        None, description='Motion: down one line (`j`).'
    )
    ...
    motion_right: KeybindingsSpec | None = Field(
        None, description='Motion: right (`l`).'
    )
    motion_up: KeybindingsSpec | None = Field(
        None, description='Motion: up one line (`k`).'
    )
...
class AppConfig(BaseModel):
    ...
    enabled: bool | None = Field(
        True, description='When `false`, Codex does not surface this app.'
    )
    open_world_enabled: bool | None = Field(
        None,
        description='Whether tools with `open_world_hint = true` are allowed for this app.',
    )
    tools: AppToolsConfig | None = Field(
        None, description='Per-tool settings for this app.'
    )
...
class HooksToml(BaseModel):
    ...
    post_tool_use: list[MatcherGroup] | None = Field(
        [], alias='PostToolUse', validate_default=True
    )
    pre_tool_use: list[MatcherGroup] | None = Field(
        [], alias='PreToolUse', validate_default=True
    )
...
class MarketplaceConfig(BaseModel):
    ...
    ref: str | None = Field(
        None, description='Git ref to check out when `source_type` is `git`.'
    )
...
class OtelExporterKind(
    RootModel[OtelExporterKind1 | OtelExporterKind2 | OtelExporterKind3]
):
...
class OtelConfigToml(BaseModel):
    ...
    metrics_exporter: OtelExporterKind | None = Field(
        None, description='Optional metrics exporter'
    )
    trace_exporter: OtelExporterKind | None = Field(
        None, description='Optional trace exporter'
    )
...
class ToolSuggestConfig(BaseModel):
    ...
    disabled_tools: list[ToolSuggestDisabledTool] | None = Field(
        [], validate_default=True
    )
    discoverables: list[ToolSuggestDiscoverable] | None = Field(
        [], validate_default=True
    )
...
class ConfigToml(BaseModel):
    ...
    apps: AppsConfigToml | None = Field(
        None, description='Settings for app-specific controls.'
    )
    ...
    debug: DebugToml | None = Field(
        None, description='Debugging and reproducibility settings.'
    )
    ...
    experimental_thread_store_endpoint: str | None = Field(
        None,
    ...
    memories: MemoriesToml | None = Field(
        None, description='Memories subsystem settings.'
    )
    ...
    permissions: PermissionsToml | None = Field(
        None, description='Named permissions profiles.'
    )
    ...
    profile: str | None = Field(
        None, description='Profile to use from the `profiles` map.'
    )
    ...
    tools: ToolsToml | None = Field(
        None, description='Nested tools section for feature toggles'
    )
    tui: Tui | None = Field(
    ...
    windows: WindowsToml | None = Field(
        None, description='Windows-specific configuration.'
    )
