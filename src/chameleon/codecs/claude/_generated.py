...
#   timestamp: 2026-05-06T06:11:20+00:00
...
class Env(BaseModel):
    ...
    claude_agent_sdk_disable_builtin_agents: (
        ClaudeAgentSdkDisableBuiltinAgents | None
    ) = Field(
        None,
    ...
    claude_bash_maintain_project_working_dir: (
        ClaudeBashMaintainProjectWorkingDir | None
    ) = Field(
        None,
    ...
    claude_code_additional_directories_claude_md: (
        ClaudeCodeAdditionalDirectoriesClaudeMd | None
    ) = Field(
        None,
    ...
    claude_code_disable_adaptive_thinking: ClaudeCodeDisableAdaptiveThinking | None = (
        Field(
            None,
    ...
    claude_code_disable_background_tasks: ClaudeCodeDisableBackgroundTasks | None = (
        Field(
            None,
    ...
    claude_code_disable_experimental_betas: (
        ClaudeCodeDisableExperimentalBetas | None
    ) = Field(
        None,
    ...
    claude_code_disable_file_checkpointing: (
        ClaudeCodeDisableFileCheckpointing | None
    ) = Field(
        None,
        alias='CLAUDE_CODE_DISABLE_FILE_CHECKPOINTING',
        description='Disable file checkpointing for undo/restore',
    )
    claude_code_disable_git_instructions: ClaudeCodeDisableGitInstructions | None = (
        Field(
            None,
    ...
    claude_code_disable_legacy_model_remap: ClaudeCodeDisableLegacyModelRemap | None = (
        Field(
            None,
    ...
    claude_code_disable_nonessential_traffic: (
        ClaudeCodeDisableNonessentialTraffic | None
    ) = Field(
        None,
    ...
    claude_code_disable_nonstreaming_fallback: (
        ClaudeCodeDisableNonstreamingFallback | None
    ) = Field(
        None,
    ...
    claude_code_enable_background_plugin_refresh: (
        ClaudeCodeEnableBackgroundPluginRefresh | None
    ) = Field(
        None,
    ...
    claude_code_enable_prompt_suggestion: ClaudeCodeEnablePromptSuggestion | None = (
        Field(
            None,
    ...
    claude_code_experimental_agent_teams: ClaudeCodeExperimentalAgentTeams | None = (
        Field(
            None,
    ...
    claude_code_provider_managed_by_host: ClaudeCodeProviderManagedByHost | None = (
        Field(
            None,
    ...
    http_proxy: str | None = Field(
        None, alias='HTTP_PROXY', description='HTTP proxy URL'
    )
...
class Source6(BaseModel):
    ...
    source: Literal['directory'] = Field(
        ..., description='Identifies the marketplace source type'
    )
    path: str = Field(
...
class Ripgrep(BaseModel):
    ...
    command: str = Field(
        ..., description='Path to the ripgrep binary to use', min_length=1
    )
...
class HookCommand1(BaseModel):
    ...
    timeout: float | None = Field(
        None, description='Optional timeout in seconds', gt=0.0
    )
...
class HookCommand5(BaseModel):
    ...
    tool: str = Field(
        ..., description='Name of the tool to call on that server', min_length=1
    )
...
class ClaudeCodeSettings(BaseModel):
    ...
    claude_md_excludes: list[ClaudeMdExclude] | None = Field(
        ...
        examples=[
            ['**/monorepo/CLAUDE.md', '/home/user/monorepo/other-team/.claude/rules/**']
        ],
    )
    ...
    strict_plugin_only_customization: bool | StrictPluginOnlyCustomization | None = (
        Field(
            None,
